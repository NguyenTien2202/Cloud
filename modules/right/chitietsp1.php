...
?>
	...
	<div class="box_chitietsp">
				...
				?>
                   ...
                   <?php
				   	$sql_lienquan="select * from sanpham where hieusp='$_GET[idhieusp]' and sanpham.idsanpham<>$_GET[id] ";
				   ...
				   ?>
                    <div class="sanphamlienquan">
                   	<div class="tieude">Sản phẩm liên quan</div>
						...
						?>
                        		 <li><a href="?quanly=chitietsp1&idhieusp=<?php echo $dong_lienquan['hieusp'] ?>&id=<?php echo $dong_lienquan['idsanpham'] ?>">
